jQuery(function(){
	...
	if ($('.animated').length) {
		...
		$(window).on('scroll', function () {
			if (!animated_flag && $('.animated').isOnScreen()) {
				animated_flag = true;
				initAnimation();
			}
		});
	...
	if($('.btt-btn-wrap').length){
		initBttBtn();
	}
});

var isInitialized; // Global variable for initMobileDropHelper()
...
function initAnchors() {
	new SmoothScroll({
		anchorLinks: '.anchor-btn, .btt-btn',
...
function initBttBtn(){
	...
	function setBtnPos(){
		var initialPosX = ($(window).width() - $btnWrap.width()) / 2;
		$btn.css({
			'left': 'auto',
			'right': initialPosX
		});
...
function initDotDotDot(){
	jQuery('.post-item .i-ttl, .post-g-item .i-ttl, .post-g-item .exp-t, .post-tabs-list .p-ttl').dotdotdot({
		height: 'watch',
		watch: true,
		truncate: 'letter'
	});
...
function initCustomForms() {
	jcf.replaceAll('.r-check-bar-form');
}

// open-close init
function initOpenClose() {
	jQuery('.r-search-bar-form').openClose({
		activeClass: 'active',
		opener: '.opener',
		slider: '.slide',
		animSpeed: 400,
	...
	jQuery('.r-check-bar-form').openClose({
		activeClass: 'active',
		opener: '.opener',
		slider: '.slide-wrap',
		animSpeed: 400,
	...
	jQuery('.filter-mobile-drop').openClose({
		activeClass: 'active',
		opener: '.opener',
		slider: '.slide-wrap',
		animSpeed: 400,
...
function initRandomLogoSet(){
	var imgArr = [{"path":"assets/img/brands/logo-set-collection/microsoft-logo.png","path2x":"assets/img/brands/logo-set-collection/microsoft-logo@2x.png"},{"path":"assets/img/brands/logo-set-collection/sprinklr-logo.png","path2x":"assets/img/brands/logo-set-collection/sprinklr-logo@2x.png"},{"path":"assets/img/brands/logo-set-collection/netapp-logo.png","path2x":"assets/img/brands/logo-set-collection/netapp-logo@2x.png"},{"path":"assets/img/brands/logo-set-collection/fujitsu-logo.png","path2x":"assets/img/brands/logo-set-collection/fujitsu-logo@2x.png"},{"path":"assets/img/brands/logo-set-collection/autodesk-logo.png","path2x":"assets/img/brands/logo-set-collection/autodesk-logo@2x.png"},{"path":"assets/img/brands/logo-set-collection/addepar-logo.png","path2x":"assets/img/brands/logo-set-collection/addepar-logo@2x.png"},{"path":"assets/img/brands/logo-set-collection/wix-logo.png","path2x":"assets/img/brands/logo-set-collection/wix-logo@2x.png"},{"path":"assets/img/brands/logo-set-collection/ironsource-logo.png","path2x":"assets/img/brands/logo-set-collection/ironsource-logo@2x.png"},{"path":"assets/img/brands/logo-set-collection/ampleorganics-logo.png","path2x":"assets/img/brands/logo-set-collection/ampleorganics-logo@2x.png"},{"path":"assets/img/brands/logo-set-collection/logmein-logo.png","path2x":"assets/img/brands/logo-set-collection/logmein-logo@2x.png"},{"path":"assets/img/brands/logo-set-collection/covermymeds-logo.png","path2x":"assets/img/brands/logo-set-collection/covermymeds-logo@2x.png"},{"path":"assets/img/brands/logo-set-collection/minitigo-logo.png","path2x":"assets/img/brands/logo-set-collection/minitigo-logo@2x.png"},{"path":"assets/img/brands/logo-set-collection/fieldin-logo.png","path2x":"assets/img/brands/logo-set-collection/fieldin-logo@2x.png"},{"path":"assets/img/brands/logo-set-collection/omeda-logo.png","path2x":"assets/img/brands/logo-set-collection/omeda-logo@2x.png"},{"path":"assets/img/brands/logo-set-collection/yandex-logo.png","path2x":"assets/img/brands/logo-set-collection/yandex-logo@2x.png"},{"path":"assets/img/brands/logo-set-collection/bob-logo.png","path2x":"assets/img/brands/logo-set-collection/bob-logo@2x.png"},{"path":"assets/img/brands/logo-set-collection/camilyo-logo.png","path2x":"assets/img/brands/logo-set-collection/camilyo-logo@2x.png"},{"path":"assets/img/brands/logo-set-collection/kounta-logo.png","path2x":"assets/img/brands/logo-set-collection/kounta-logo@2x.png"},{"path":"assets/img/brands/logo-set-collection/appdome-logo.png","path2x":"assets/img/brands/logo-set-collection/appdome-logo@2x.png"},{"path":"assets/img/brands/logo-set-collection/outbrain-logo.png","path2x":"assets/img/brands/logo-set-collection/outbrain-logo@2x.png"},{"path":"assets/img/brands/logo-set-collection/premier-logo.png","path2x":"assets/img/brands/logo-set-collection/premier-logo@2x.png"},{"path":"assets/img/brands/logo-set-collection/connectik-logo.png","path2x":"assets/img/brands/logo-set-collection/connectik-logo@2x.png"},{"path":"assets/img/brands/logo-set-collection/forter-logo.png","path2x":"assets/img/brands/logo-set-collection/forter-logo@2x.png"},{"path":"assets/img/brands/logo-set-collection/usa_today-logo.png","path2x":"assets/img/brands/logo-set-collection/usa_today-logo@2x.png"},{"path":"assets/img/brands/logo-set-collection/et_grow-logo.png","path2x":"assets/img/brands/logo-set-collection/et_grow-logo@2x.png"},{"path":"assets/img/brands/logo-set-collection/jfrog-logo.png","path2x":"assets/img/brands/logo-set-collection/jfrog-logo@2x.png"},{"path":"assets/img/brands/logo-set-collection/amicus-logo.png","path2x":"assets/img/brands/logo-set-collection/amicus-logo@2x.png"},{"path":"assets/img/brands/logo-set-collection/reorg_reaserch-logo.png","path2x":"assets/img/brands/logo-set-collection/reorg_reaserch-logo@2x.png"},{"path":"assets/img/brands/logo-set-collection/ubimo-logo.png","path2x":"assets/img/brands/logo-set-collection/ubimo-logo@2x.png"},{"path":"assets/img/brands/logo-set-collection/jacada-logo.png","path2x":"assets/img/brands/logo-set-collection/jacada-logo@2x.png"},{"path":"assets/img/brands/logo-set-collection/time_to_know-logo.png","path2x":"assets/img/brands/logo-set-collection/time_to_know-logo@2x.png"},{"path":"assets/img/brands/logo-set-collection/optibus-logo.png","path2x":"assets/img/brands/logo-set-collection/optibus-logo@2x.png"},{"path":"assets/img/brands/logo-set-collection/origami-logo.png","path2x":"assets/img/brands/logo-set-collection/origami-logo@2x.png"}]
	var randomNums = [];

	for(var i = 1; randomNums.length < 6; i++){
	...
	randomNums.forEach(function(item, index){
		var path = imgArr[item].path;
		var path2x = imgArr[item].path2x;
		$('.logo-set').append(`<li>
									<img src="${path}" srcset="${path2x} 2x" alt="" width="" height="">
								</li>`)
	})
	setInterval(() => {
		var randomNum = getRandomArbitrary();
		...
		var ele = getRandomEle();
		var path = imgArr[randomNum].path;
		var path2x = imgArr[randomNum].path2x;
		randomNums[ele - 1] = randomNum;
		jQuery('.logo-set li:nth-child(' + ele + ') img').fadeOut(500, function() {
			jQuery('.logo-set li:nth-child(' + ele + ') img').attr('src', path);
			jQuery('.logo-set li:nth-child(' + ele + ') img').attr('srcset', path2x + ' 2x');
			jQuery('.logo-set li:nth-child(' + ele + ') img').fadeIn(500);
		});
	}, 2500);
	function getRandomArbitrary() {
		return Math.floor(Math.random() * (imgArr.length - 1) + 1);
	}
	function getRandomEle() {
		return Math.floor(Math.random() * 6);
	}
}

function initStickyElems(){
	function getHeaderHeight(){
		return $('#header').height();
	}
	$(".entry-and-sidebar-s .sidebar").stick_in_parent({
		parent: '.entry-and-sidebar-s',
		offset_top: getHeaderHeight()
	});
	$("#sticky-filter-wrap").stick_in_parent({
		parent: '#main',
		offset_top: getHeaderHeight()
	});
	...
	$win.on('resize', function(){
		...
		resizeTimer = setTimeout(function() {
			if ($win.outerWidth() != windowWidth || $win.outerHeight() != windowHeight) {
				windowWidth = $win.width();
				windowHeight = $win.height();
				$("#sticky-filter-wrap").trigger("sticky_kit:detach");
				$("#sticky-filter-wrap").stick_in_parent({
					parent: '#main',
					offset_top: getHeaderHeight()
				});
...
function initViewportChecker(){
	$('.js-video-play-onscroll').viewportChecker({
		classToAdd: 'playing-now',
		removeClassAfterAnimation: true,
		repeat: true,
		callbackFunction: function(elem, action){
			if(!$(elem).hasClass('playing-now')){
				$(elem)[0].pause();
				$(elem)[0].currentTime = 0;
			} else {
				if($(elem)[0].paused && $(elem)[0].currentTime == 0){
					$(elem)[0].play();
				} else {
					return
				}
...
function initResponsiveHelper(){
	// Instead of $(window).resize() event
	var $win = jQuery(window);
	var windowWidth = $win.width();
	var windowHeight = $win.height();
	var resizeTimer;
	$win.on('resize', function(){
		...
		resizeTimer = setTimeout(function() {
			if ($win.outerWidth() != windowWidth || $win.outerHeight() != windowHeight) {
				...
				windowHeight = $win.height();
				initMobileDropHelper();
				$('.h-nav>li.has-drop').removeClass('active');
				$('.h-nav>li.has-drop .drop').hide();
			}
		}, 500);
	});
}
...
function initCustomHover() {
	jQuery('.t-slider-box').touchHover({});
}
...
function initSwiper(){
	...
	var enableMobileSwiper = function(){
		mobileSwiper = new Swiper('.posts-grid-mobile-slider', {
			loop: false,
			roundLengths: true,
			speed: 300,
			initialSlide: 0,
	...
	function reInitPostSlider() {
		if($('.posts-grid-mobile-slider').length){
			if(windowWidth <= 1023){
...
function initTabs() {
	// Tabs home page
	jQuery('#h-fade-tabs .tabset').tabset({
		tabLinks: '.tab-opener',
		addToParent: true,
		attrib: 'data-tab',
		defaultTab: true
	});
	$('#h-fade-tabs .tab-opener').on('click', function(){
		var tabData = $(this).data('tab');
		if($(tabData).children().is('.tab-video')){
			$(tabData).find('video')[0].currentTime = 0;
			$(tabData).find('video')[0].play();
		}
	});

	// Tabs posts
	jQuery('#post-tabs .tabset').tabset({
		tabLinks: '.tab-opener',
		addToParent: true,
		attrib: 'data-tab',
		defaultTab: true
	...
	// Tabs hero section
	jQuery('#hero-tabs .tabset').tabset({
		tabLinks: '.tab-opener',
		addToParent: true,
		attrib: 'data-tab',
		defaultTab: true
...
function initDropHandler(){
	...
	$('.h-nav>li').has('.drop').addClass('has-drop');
	$('.h-nav>li.has-drop>a').on('click', e => e.preventDefault())
	$('.h-nav>li .drop').each(function(){
...
function handleDrop(){
	...
	if(!$li.hasClass('active')){
		$li.addClass('active')
		$li.find('.drop').stop().slideDown(300);
	} else {
		$li.removeClass('active')
		$li.find('.drop').stop().slideUp(300);
	}
}

function initMobileDropHelper(){
	var $win = $(window);

	if($win.width() < 1024){
		if(!isInitialized){
			$('.h-nav>li.has-drop>a').on('click', handleDrop)
			isInitialized = true;
		}
	} else {
		if(isInitialized){
			$('.h-nav>li.has-drop>a').off('click', handleDrop)
			isInitialized = false;
		}
	}
}
...
function initAnimation(){
	$('#drs-3').addClass('active');
	$('#dd-4').addClass('active');
	$('#di-4').addClass('active');
	setTimeout(() => {
		$('#drs-4').addClass('active');
		$('#dd-3').addClass('active');
		$('#di-5').addClass('active');
	}, 3500);
	setTimeout(() => {
		$('#drs-2').addClass('active');
		$('#dd-2').addClass('active');
		$('#di-3').addClass('active');
		$('#dis-3').addClass('active');
	}, 6000);
	setTimeout(() => {
		$('#drs-1').addClass('active');
 ...
 */
!function(t){function i(i){this.options=t.extend({container:null,hideOnClickOutside:!1,menuActiveClass:"nav-active",menuOpener:".nav-opener",menuDrop:".nav-drop",toggleEvent:"click",outsideClickEvent:"click touchstart pointerdown MSPointerDown"},i),this.initStructure(),this.attachEvents()}i.prototype={initStructure:function(){this.page=t("html"),this.container=t(this.options.container),this.opener=this.container.find(this.options.menuOpener),this.drop=this.container.find(this.options.menuDrop)},attachEvents:function(){var i=this;e&&(e(),e=null),this.outsideClickHandler=function(e){if(i.isOpened()){var n=t(e.target);n.closest(i.opener).length||n.closest(i.drop).length||i.hide()}},this.openerClickHandler=function(t){t.preventDefault(),i.toggle()},this.opener.on(this.options.toggleEvent,this.openerClickHandler)},isOpened:function(){return this.container.hasClass(this.options.menuActiveClass)},show:function(){this.container.addClass(this.options.menuActiveClass),this.options.hideOnClickOutside&&this.page.on(this.options.outsideClickEvent,this.outsideClickHandler)},hide:function(){this.container.removeClass(this.options.menuActiveClass),this.options.hideOnClickOutside&&this.page.off(this.options.outsideClickEvent,this.outsideClickHandler)},toggle:function(){this.isOpened()?this.hide():this.show()},destroy:function(){this.container.removeClass(this.options.menuActiveClass),this.opener.off(this.options.toggleEvent,this.clickHandler),this.page.off(this.options.outsideClickEvent,this.outsideClickHandler)}};var e=function(){var i,e,n=t(window),o=t("html"),a=function(){i=!1,o.removeClass("resize-active")};n.on("resize orientationchange",function(){i||(i=!0,o.addClass("resize-active")),clearTimeout(e),e=setTimeout(a,500)})};t.fn.mobileNav=function(e){var n=Array.prototype.slice.call(arguments),o=n[0];return this.each(function(){var a=jQuery(this),s=a.data("MobileNav");"object"==typeof e||void 0===e?a.data("MobileNav",new i(t.extend({container:this},e))):"string"==typeof o&&s&&"function"==typeof s[o]&&(n.shift(),s[o].apply(s,n))})}}(jQuery),window.ResponsiveHelper=function(t){var i,e=[],n=t(window),o=!1;function a(){var o=n.width();o!==i&&(i=o,t.each(e,function(i,e){t.each(e.data,function(t,i){i.currentActive&&!s(i.range[0],i.range[1])&&(i.currentActive=!1,"function"==typeof i.disableCallback&&i.disableCallback())}),t.each(e.data,function(t,i){!i.currentActive&&s(i.range[0],i.range[1])&&(i.currentActive=!0,"function"==typeof i.enableCallback&&i.enableCallback())})}))}function s(t,e){var n="";return t>0&&(n+="(min-width: "+t+"px)"),e<1/0&&(n+=(n?" and ":"")+"(max-width: "+e+"px)"),function(t,e,n){return window.matchMedia&&o?matchMedia(t).matches:window.styleMedia?styleMedia.matchMedium(t):window.media?media.matchMedium(t):i>=e&&i<=n}(n,t,e)}return window.matchMedia&&(window.Window&&window.matchMedia===Window.prototype.matchMedia?o=!0:window.matchMedia.toString().indexOf("native")>-1&&(o=!0)),n.bind("load resize orientationchange",a),{addRange:function(n){var o={data:{}};t.each(n,function(t,i){var e,n;o.data[t]={range:(e=t,n=e.split(".."),[parseInt(n[0],10)||-1/0,parseInt(n[1],10)||1/0].sort(function(t,i){return t-i})),enableCallback:i.on,disableCallback:i.off}}),e.push(o),i=null,a()}}}(jQuery);
/*
 * Mobile hover plugin
 */
!function(e){var o=jQuery(document),n="ontouchstart"in window||window.DocumentTouch&&document instanceof DocumentTouch,t=/Windows Phone/.test(navigator.userAgent),r=(n?"touchstart":t&&navigator.pointerEnabled&&"pointerdown")||t&&navigator.msPointerEnabled&&"MSPointerDown"||"mouseenter",s=(n?"touchend":t&&navigator.pointerEnabled&&"pointerup")||t&&navigator.msPointerEnabled&&"MSPointerUp"||"mouseleave";n=/Windows Phone/.test(navigator.userAgent)||"ontouchstart"in window||window.DocumentTouch&&document instanceof DocumentTouch,e.fn.touchHover=function(t){var a=e.extend({hoverClass:"hover"},t);return this.on(r,function(e,t){var a=jQuery(t.currentTarget);n?a.hasClass(e.hoverClass)||(jQuery(this).off("click.hover",function(e){e.preventDefault()}),setTimeout(function(){o.on(r+".hover",function(n){var t=jQuery(n.target);t.is(a)||t.closest(a).length||(a.removeClass(e.hoverClass),jQuery(this).off("click.hover"),o.off(r+".hover"))})})):a.one(s,function(){jQuery(this).removeClass(e.hoverClass)}),a.hasClass(e.hoverClass)||(t&&t.preventDefault(),a.addClass(e.hoverClass))}.bind(this,a)),this}}(jQuery);
/**
 * Swiper 5.0.4
